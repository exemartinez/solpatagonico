...
<table width="640" border="0" align="center" cellpadding="3" cellspacing="0">
	<tr> 
		<th class="titulosizquierda" align="center" colspan="4" style="font-size: 14px; font-weight: bold">Grupos</th>
	</tr>
<?
		if ( $error != '' ){
?>
...
<table width="640" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<th colspan="2" class="titulosizquierda" align="center" style="font-size: 14px; font-weight: bold"><?=$action=='frmModificar'?'Modificar':($action=='frmBaja'?'Borrar':'Agregar')?> Grupo</th>
	</tr>
<?
		if ( $error != '' ){
?>
...
<table align="center" width="640" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<th class="titulosizquierda" style="font-size: 14px; font-weight: bold">Permisos para el grupo: <?=$nombre_grupo?></th>
	</tr>
<?
...
?>
	<table align="center" width="640" cellpadding="0" cellspacing="0" border="0">
		<tr>
			<th colspan="2" class="titulosizquierda" style="font-size: 14px; font-weight: bold">Acciones para el grupo: 
			<?=$nombre_grupo?></th>
		</tr>
		<?
