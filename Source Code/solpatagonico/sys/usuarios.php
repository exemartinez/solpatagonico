...
<table width="640" cellpadding="3" cellspacing="0" border="0" align="center">
	<tr>
		<th class="titulosizquierda" align="center" colspan="5">Usuarios</th>
	</tr>
<?
		if ( $error != '' ){
?>
...
?>
	<tr> 
		...
		<td class="<?=$class?>" align="center"><a 
			href="<?=$_SERVER['PHP_SELF']?>?id=<?=$usuario->id?>&action=frmModificar"><img
			src="../sys_images/list.gif" alt="Modificar Registro" border="0" /></a> 
			<a href="javascript: if (confirm ('<?=$msgDelete?>')) { location = '<?=$_SERVER['PHP_SELF']?>?action=Borrar&id=<?=$usuario->id?>'; }"> <img
			src="../sys_images/delete.gif" alt="Eliminar Registro" border="0" /></a></td>
	</tr>
<?
			}
		}
...
<table width="640" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <th colspan="2" class="titulosizquierda">Usuario</th>
  </tr>
  <?
		if ( $error != '' ){
?>
...
?>
  <tr>
    ...
    <td class="cuadro1" width="490"><input style="width: 85%" name="usuario" type="text" value="<?= printif( $usuario, $reg->usuario ) ?>" validar="int:El nombre de usuario debe ser numérico de 8 digitos."></td>
  </tr><?
  ...
  <tr>
    ...
    <td class="cuadro1"><input style="width: 85%" name="nombre" type="text" value="<?= printif( $_POST['nombre'], $reg->nombre ) ?>" validate="str:Debe ingresar nombre."></td>
  </tr>
  <tr>
    <td class="cuadro1izquierda">Direcci&oacute;n</td>
    <td class="cuadro1"><input style="width: 85%" name="direccion" type="text" value="<?= printif( $_POST['direccion'], $reg->direccion ) ?>"></td>
  </tr>
  <tr>
    <td class="cuadro1izquierda">Localidad</td>
    <td class="cuadro1"><input style="width: 85%" name="localidad" type="text" value="<?= printif( $_POST['localidad'], $reg->localidad ) ?>"></td>
  </tr>
  <tr>
    <td class="cuadro1izquierda">CP</td>
    <td class="cuadro1"><input style="width: 85%" name="cp" type="text" value="<?= printif( $_POST['cp'], $reg->cp ) ?>"></td>
  </tr>
  <tr>
    <td class="cuadro1izquierda">Tel&eacute;fono</td>
    <td class="cuadro1"><input style="width: 85%" name="telefono" type="text" value="<?= printif( $_POST['telefono'], $reg->telefono ) ?>"></td>
  </tr>
  <tr>
    <td class="cuadro1izquierda">*e-mail</td>
    <td class="cuadro1"><input style="width: 85%" name="mail" type="text" value="<?= printif( $_POST['mail'], $reg->mail ) ?>"  validate="email:Debe ingresar un email válido."></td>
  </tr>
  <tr>
    <td class="cuadro1izquierda">Nota</td>
    <td class="cuadro1"><textarea style="width: 85%" name="nota" wrap="VIRTUAL"><?= htmlentities( printif( $_POST['nota'], $reg->nota ) ) ?>
</textarea></td>
  </tr>
  <tr>
    <td class="cuadro1izquierda">Bloqueado</td>
    <td class="cuadro1"><input name="bloqueado" <?= printif( $_POST['bloqueado'], $reg->bloqueado ) ? 'checked' : '' ?> type="checkbox" id="bloqueado" value="1"></td>
  </tr>
...
?>
  <tr>
    ...
    <td class=cuadro2><script language="javascript" type="text/javascript">
        ...
        <input type="button" value="Aceptar" onClick="enviar()">&nbsp;<input type="button" value="Cancelar" name="Button" onClick="javascript:location = '<?=$_SERVER['PHP_SELF']?>?id_padre=<?=$id_padre?>'">        </td>
  </tr>
</table>
</form>
<?
