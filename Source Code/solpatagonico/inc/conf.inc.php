<?
    ...
    registrar("action,id,id_cliente,id_zona,id_sucursal,codigo,cod_sucursal,cod_cliente,cod_producto,cantidad,stock,precio,proveedor_lst,ocultar_eliminados,br,proveedor_lst,nombre_list,cuit_list,nombre_list,cliente_lst,zona_lst,cuit_lst,producto_lst,codigo_list,estado_lst,rubro_lst,rubro_list,cantidad_real,cantidad,mod_stock,new_stock,id_producto,nom_producto,codigo_producto,list_clientes,list_sucursales,list_productos,objResponse,tbl_items,items,dni_transportista,tr_camionero,td_nombreapellido,td_dni,dni_list,tipo_lst,fecha,desde,hasta,id_estado_pedido,cuit,id_proveedor" );
